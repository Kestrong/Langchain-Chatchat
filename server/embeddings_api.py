...
def embed_texts_endpoint(
        input: List[str] = Body(..., description="要嵌入的文本列表", examples=[["hello", "world"]]),
        model: str = Body(EMBEDDING_MODEL,
    ...
    '''
    return embed_texts(texts=input, embed_model=model, to_query=to_query)
